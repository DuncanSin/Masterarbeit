...
Der erste Prozessor aus dem heterogenen Dualcore-Prozessor DM8168 ist ein Cortex-A8 der Firma ARM. Er besteht im wesentlichen aus 7 Komponenten (vgl. \textbf{Abbildung \ref{fig:a8}}):
...
\begin{itemize}
	...
	\item Load/Store
	\item L2 Cache
	\item NEON (\textbf{\ref{subsec:neon}}
	\item ETM
\end{itemize}
%
\begin{figure}[h]
...
\subsubsection{Der NEON-Coprozessor}\label{subsec:neon}
