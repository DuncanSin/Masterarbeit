...
\paragraph{Software Pipelined Loop (SPLOOP)}$\;$ \\

Neben der Hardwarepipeline bietet der C674x eine weitere Pipeline-Struktur. Diese besteht zum einen Teil aus Hardware und zum anderen Teil aus Planungsarbeit, die während der Kompilierung vom Compiler aufgebracht wird.\\
Software Pipelined Loop oder auch kurz SPLOOP bietet eine Möglichkeit Schleifen, welche im Programm vorkommen, in Form einer Pipeline abzuarbeiten. Hierfür sind Hardwarekomponenten innerhalb des C674x vorhanden:
