...
Die OSC-Merkmale erfordern mit 57,7\% bei FSet2 die höchste Laufzeit. 76\% der Laufzeit dieses Merkmals fallen auf das verwendete Sortierverfahren. Eine Optimierung gängiger Sortierverfahren wie MergeSort oder QuickSort durch die Verwendung von SIMD-Instruktionen ist auf Grund der  Rechenkomplexität nicht ohne weiteres möglich. In dieser Arbeit wird daher das Sortierverfahren nciht optimiert, jedoch kann ein möglicher Optimierungsansatz für die Laufzeitreduktion durch SIMD-Instruktionen auf dem Bitonic-Sortierverfahren basieren, dessen Rechenkomplexität datenunabhängig ist.\\ 
