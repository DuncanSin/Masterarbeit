...
\begin{figure}[h]
	...
	\caption{Laufzeitmessungen von Refezenz-FFT und Libav-FFT für ARM, ARM+VFP und ARM+NEON}
	\label{fig:libavtime}
\end{figure} 
%
...
\begin{figure}[h]
	...
	\caption{Laufzeitmessung von Magnitude of Spectrum für ARM, ARM+VFP und ARM+NEON}
	\label{fig:mag}
\end{figure} 
%
