...
\section{Optimierung des ARM}\label{sec:optarm}
...
\end{figure} 
%
Wie man in der Abbildung sieht, ergeben sich nach dieser Optimierung vier Algorithmen, die langsamer sind als die neue FFT, hinzu kommt noch ein weiterer Algorithmus aus FeatureSet 3:
...
\begin{figure}[h]
	...
	\caption{Gegenüberstellung der Laufzeiten der optimierten Algorithmen vor und nach der Optimierung auf dem ARM}
	\label{fig:endarm}
\end{figure} 
%
Wie man der Abbildung entnehmen kann, wurde der größte Speedup bei der FFT-Berechnung erreicht. Dieser beträgt, wie schon in \textbf{Kapitel \ref{subsec:optFFT}} erwähnt knapp 19,2. Des weiteren wurden bei Magnitude of Spectrum ein Speedup von 2, bei MFCC ein Speedup von 1,2 und beim Hamming Window von 3,4 erreicht. Für die gesamte Extraktion des FeatureSets 2 wird ein Speedup von 2,7 erreicht.
