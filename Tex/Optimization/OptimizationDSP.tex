...
\section{DSP-spezifische Optimierung der portierten Merkmalsextraktion}\label{sec:optdsp}
...
Die Ersetzung des Quick Sort-Verfahrens durch das in \cite{sort} vorgeschlagene Merge Sort-Verfahren beschleunigt die Berechnung des OSC-Merkmals um den Faktor ... . Insgesamt wird hierdurch die Berechnung von FSet2 um den Faktor ... beschleunigt.
