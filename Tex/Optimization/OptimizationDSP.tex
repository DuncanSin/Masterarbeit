...
Für die Merkmalsextraktion auf dem C674x DSP wurde eine C-Version der C++-Referenz-Klasse geschrieben, da der Compiler C++ nur in geringem Umfang unterstützt. Außerdem wurde für die Einbindung der Merkmalsextraktion in den ARM-Code C6Runlib gewählt, weil für C6Runapp keine Komunikationsprotokolle definiert sind.\\
Die Laufzeiten zur Extraktion der Merkmale und zur Durchführung erforderlicher Algorithmen sind in \textbf{Abbildung \ref{fig:startdsp}}  zu sehen.\\
%
\begin{figure}[h]
	\centering
...
Eine genaue Analyse der Laufzeit der MAG-Berechnung zeigt, dass 98\% der Verarbeitungszeit auf die Berechnungen der Division und Wurzeln fallen, die mehrfach ausgeführt werden. Zur Beschleunigung dieser Operationen eignen sich die MATHLIB-Funktionen für vektorielle Eingabewerte.\\
...
Hierbei ist zu erwähnen, dass die Addition innerhalb der Wurzelberechnung zusätzlich für eine bessere Ausführung durch SPLOOP aufgetrennt wird.\\
