...
Der Leistungsverbrauch der beiden Prozessorkerne wird aus \cite{power} entnommen. Der ARM Cortex A8 kommt dabei auf einen Leistungsverbrauch von 169 mW und der C674x auf einen zusätzlichen Leistungsverbrauch von 141 mW.
...
Bei der Betrachtung der Energie-Effizienz beider Ansätze erkennt man, dass hier die ... Version die besseren Ergebnisse liefert (vgl. \textbf{Abbildung \ref{fig:enhete}}).
