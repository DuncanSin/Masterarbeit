...
Und für die zweite Sumem aus (\textbf{\ref{eqn:dif3b}}):
...
Bei der Amplitude of Spectrum wird werden die normalisierten Spektrakomponenten eines Fenster berechnet. \\
Hierfür wird zu erst der Betrag der diskreten Transformierten berechnet, der dannach durch die Größe des betrachteten Fensters geteilt wird (\textbf{Formel \ref{eqn:aos}}).
...
Im nächsten Schritt wird der Logerithmus von $M(k')$ gebildet. Letztendlich wird zur Berechnung der MFCC eine Diskrete Cosinuns Transformation (DCT) durchgeführt.\\
...
Der Normalized Audio Spectrum Envelope (NASE) gibt Auskunft über das Energiespekturm jedes Fensters. Hierbei wird pro Fenster ein Vektor generiert, bei dem jedes Vektorelement die normalisierte, quadrierte Magnitude eines definierten Frequenz-Unterbandes entspricht.\\
...
Die Berechnung der einzelnen NASE-Werte erfolg hierbei in drei Schritten.\\
...
Dieser Factor wird auf folgenden Frequenzbändern berechnet\cite{Theimer2008}:
\begin{itemize}
