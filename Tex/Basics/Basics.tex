...
Klassifikationsalgorithmen erwarten, dass die Anzahl an Daten eines zu klassifizierenden Musikstücks mit der Anzahl der Daten in ihrem Referenzsets übereinstimmen. Da im Normalfall aber nicht alle Musikstücke nicht die selbe Länge und damit mit die selbe Fensteranzahl besitzten, muss eine Datenreduktion durchgeführt werden. Dieses geschieht in der Prozessierungsphase.\\
...
\begin{enumerate}
\item Aufstellen des Merkmalraums anhand eines Trainingsets
\item Abbilden des zu klassifizierenden Objekt in diesen Merksmalsraums und Klassifikation
\end{enumerate}

Der Ablauf einer Klassifikation wird nachfolgend am Beispiel der Support Vector Maschine (SVM) näher erklärt.\\\\
...
Vor Beginn der Klassifikation muss der Merkmalraum aus einem Trainingsset aufgespannt werden. Hierfür wird dieses in ein Koordinatensystem eingelesen, dass 
