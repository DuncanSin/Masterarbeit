...
Diese Unterteilung geschieht auf Basis des zu betrachtenden Merkmalraums. Wir dieser nur durch zwei Merkmale aufgespannt, wird die SVM als linear bezeichnet, beinhaltet er mehr als zwei Merkmale, wird die SVM als nichtlinear bezeichnet.\\
